        ...
        <div class="wrapper">
            <div class="innerwrap">
                ...
                <div class="input_wrapper">
                    ...
                    @if (isset($page['route']) && array_search($page['route'], array_keys(config('custom.page_info')), false) === false && strpos($page['name'],'CONTACT') === false)
                ...
                @foreach ($pages as $page)
                    @if(strpos($page['name'],'contact') === false)
